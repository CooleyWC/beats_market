...
class User(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-_password_hash','-purchases.user', '-reviews.user', '-reviews.instrument', 
    ...
    instruments = db.relationship('Instrument', secondary='purchases', back_populates='users')
